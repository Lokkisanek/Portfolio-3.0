...
import { PLACEHOLDER_THUMB, PROJECTS } from '@/lib/data';
...
const ProjectList = () => {
    ...
    const handleMouseEnter = (slug: string) => {
        ...
        if (!project || project.thumbnail === PLACEHOLDER_THUMB) {
            return;
        }
    ...
    const previewProject = PROJECTS.find((p) => p.slug === selectedProject);
    const showPreview =
        previewProject && previewProject.thumbnail !== PLACEHOLDER_THUMB;
            ...
            <div className="container">
                ...
                <div className="group/projects relative" ref={containerRef}>
                    {showPreview && (
                        ...
                        >
                            {PROJECTS.filter(
                                (p) => p.thumbnail !== PLACEHOLDER_THUMB,
                            ).map((project) => (
                                <Image
